...
# -*- coding: utf-8 -*-
"""
Amazon DE Birleştirme Scripti
amazon de1.csv ve amazon de2.csv dosyalarını birleştirir, duplicate ASIN'leri temizler.
"""
...
def merge_amazon_de():
    file1 = "amazon de1.csv"
    file2 = "amazon de2.csv"
    ...
    print(f"\nBirleştirilmiş toplam: {len(df_merged)} satır")
    
    # Duplicate ASIN kontrolü ve temizleme
    if 'ASIN' in df_merged.columns:
        ...
        print("\nUyarı: 'ASIN' sütunu bulunamadı, duplicate kontrolü yapılamadı!")
    
    # Sonuçları kaydet
    df_merged.to_csv(output_file, index=False, encoding='utf-8-sig')
    print(f"\n✓ Birleştirilmiş dosya kaydedildi: {output_file}")
    print(f"Final satır sayısı: {len(df_merged)}")
